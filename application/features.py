...
# '''
# modularized content-based recommendations for API calls
# '''
# def generate_recommendations(playlist_url, number_of_recs):
#     df, success = extract(playlist_url)
#     if not success:
#         return None, df  # Return None and the error message
...
#             })
#         return recommendations, None  # Return the recommendations and no error
